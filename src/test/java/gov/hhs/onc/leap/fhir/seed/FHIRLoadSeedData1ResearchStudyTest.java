...
import gov.hhs.onc.leap.services.clients.FHIROrganization;
import gov.hhs.onc.leap.services.clients.FHIRPractitioner;
import gov.hhs.onc.leap.services.clients.FHIRResearchStudy;
...
public class FHIRLoadSeedData1ResearchStudyTest {
    ...
    void setup() {
        ...
        try {
            Bundle bundle = fhirOrganization.createOrganization(org);
        }
        catch (Exception ex) {}
        ...
        try {
            Bundle bundle = fhirPractitioner.createPractitioner(p);
        }
        catch (Exception ex) { }
    }
    ...
    void createResearchStudy() throws Exception {
        ...
        Bundle resultStudyBundle = fhirResearchStudy.createResearchStudy(researchStudy);
        Assert.assertNotNull(resultStudyBundle);
    }
